...
<body>
                            ...
                            <div class="form-field">
                                <div class="select-wrap">
                                    ...
                                    <select name="service" id="service" class="form-control">
                                        ...
                                        <option value="Air Conditioning repair and Maintenance">Air Conditioning repair
                    ...
                    <div class="row no-gutters slider-text align-items-center justify-content-start">
                        <div class="row-md-6 ftco-animate">
                            <div class="text w-100">
                                <h1>TechSolve</h1>
                                <h2 class="mb-4">
                                    A website where expert technicians from different field domains offer their services
                                    to the community around them </h2>
                                <p><a href="https://wa.me/237650423184" class="btn btn-secondary">Book an appointment</a>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4 services ftco-animate">
                    ...
                    <div class="d-block d-flex">
                        ...
                        <div class="media-body pl-3">
                            ...
                            <p>Our automotive experts are here to help. Whether it's routine maintenance or major
                                repairs, TechSolve connects you with skilled mechanics who will get you back on the road
                                in no time. Drive with confidence, thanks to TechSolve!</p>
                            <p><a href="#" class="btn-custom">Read more</a></p>
                        </div>
                    </div>
                ...
                <div class="col-md-4 services ftco-animate">
                    <div class="d-block d-flex">
                        ...
                        <div class="media-body pl-3">
                            ...
                            <p>Security is our priority. Our experienced locksmiths provide reliable and efficient door
                                lock fitting and repair services, ensuring your home or office remains secure. Trust
                                TechSolve for all your locksmith needs.</p>
                            <p><a href="#" class="btn-custom">Read more</a></p>
                        </div>
                    </div>
                    <div class="d-block d-flex">
                ...
                <div class="col-md-6 pl-md-5">
                    <div class="row justify-content-start py-5">
                        <div class="col-md-12 heading-section ftco-animate">
                            ...
                            <h2 class="mb-4">We want to serve everyone around us by putting smiles on their faces
                            </h2>
                            <p>People choose TechSolve for its expert technicians, user-friendly platform, and
                                commitment to customer satisfaction. Our certified professionals provide top-quality
                                service across a wide range of technical needs, while our easy booking system and
                                real-time tracking ensure a seamless experience. With competitive, transparent pricing
                                and reliable support, TechSolve consistently earns positive reviews and prioritizes
                                customer convenience and security.</p>
                            <div class="tabulation-2 mt-4">
                                ...
                                <div class="tab-content rounded mt-2">
                                    <div class="tab-pane container p-0 active" id="home1">
                                        <p>To provide users with easy access to professional technicians for a wide
                                            range of repair and maintenance services. We aim to deliver quick, reliable,
                                            and high-quality solutions, ensuring customer satisfaction and building a
                                            trusted network of experts to address all your technical needs efficiently.
                                        </p>
                                    </div>
                                    <div class="tab-pane container p-0 fade" id="home2">
                                        <p>To be the leading platform that seamlessly connects users with skilled
                                            ...
                                            excellence. Our goal is to revolutionize repair services, ensuring every
                                            user experiences quick, reliable, and high-quality solutions for their
                                            maintenance needs.</p>
                                    </div>
                                    <div class="tab-pane container p-0 fade" id="home3">
                                        <p>TechSolve is your go-to platform for connecting with expert technicians
                                            across various fields, including plumbing, electronics, computers, phones,
                                            door locks, cars, and bikes. It offers quick, reliable, and professional
                                            repair services, ensuring your issues are resolved efficiently. With
                                            TechSolve, you gain access to a network of certified professionals who
                                            provide top-notch solutions, making your life easier and more secure.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="ftco-appointment ftco-section ftco-no-pt ftco-no-pb img" id="booking"
        ...
        <div class="container">
            <div class="row d-md-flex justify-content-end">
                <div
                    ...
                    <form action="send_email.php" method="POST" class="appointment">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="form-field">
                                        <div class="select-wrap">
                                            ...
                                            <select name="services" id="" class="form-control">
                                                ...
                                                <option value="door_lock_fitting">Door Lock Fitting</option>
                                                <option value="car_and_bike_repairs">Car and Bike Repairs</option>
                                                <option value="computer_and_phone_repairs">Computer and Phone Repairs
                                                </option>
                                                <option value="air_conditioning_repair_and_maintenance">Air
                                                    Conditioning repair and Maintenance</option>
        ...
        <div class="container">
                ...
                <div class="col-md-6 col-lg">
                    <div class="ftco-footer-widget mb-4 ml-md-5">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="#" class="py-1 d-block"><span class="fa fa-check mr-3"></span>Door
                                    Lock Fitting</a></li>
                            <li><a href="#" class="py-1 d-block"><span class="fa fa-check mr-3"></span>Car and
                                    Bike Repairs</a></li>
                            <li><a href="#" class="py-1 d-block"><span class="fa fa-check mr-3"></span>Air
                                    Conditioning repair and Maintenance</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6 col-lg">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                ...
                                <li><a href="#"><span class="icon fa fa-phone"></span><span class="text">+237
                                            650 423 184</span></a></li>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <p class="text-muted">TechSolve With <i class="mb-1 text-primary ms-1 icon-sm"
